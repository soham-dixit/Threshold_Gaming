...
<html lang="en">
  <head>
	 ...
	 <meta name="description" content="Ping Us" />
...
<body>
	 ...
	 <script> $('.item').click(function(){
	  ...
	  <article>
		...
		<div class="zoomer">
			<div class="fadeIn">
			   <section class="py-7 py-md-0 bg-hero" id="contact"> 
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form">
				...
				<div class="wrap-input100 validate-input" data-validate = "Message is required">
					<textarea id="message" class="input100" name="message" placeholder="How Can We Help You?"></textarea>
					<span class="focus-input100"></span>
				</div>

				<div class="container-contact100-form-btn">
					<button  class="btn btn-primary d-inline-flex flex-row">
			...
			<div class="contact100-more flex-col-c-m" style="background-image: url('images/bg-01.jpg');">
				...
				<div class="dis-flex size1 p-b-47">
					...
					<div class="flex-col size2">
						...
						<span class="txt3">
							<a href="mailto:gamingcommunity@gmail.com" style="color: #00ad5f;">
								thresholdgaminghelp@gmail.com
						    </a>
						</span>
					</div>
				</div>
	...
	<div class="container">
	  <div class="row">
		...
		<div class="col-sm-2">
		  <h5>Help</h5>
		  <ul class="list-unstyled">
		  <p><a href="../contactus_aboutus/aboutloading.php">About Us</a></p>
